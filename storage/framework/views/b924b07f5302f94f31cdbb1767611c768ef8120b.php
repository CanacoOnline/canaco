    ...
    <div class="full">
        <main class="divCenterJA">
            <form action="<?php echo e(route('productUpdate',['producto_id'=>$edit->id])); ?>" method="post"
                enctype="multipart/form-data" class="panel borde boxShadow  mar20 pad20 rel" id="uploadForm">
                <?php echo csrf_field(); ?>

                <h1 class="txtB tam36 txtCenter pad20">Editar Producto</h1>
                <!--Tipo-->
                ...
                <div class="flex wrap justify-content-center marB20">
                    ...
                    <select id="categoria" name="categoria"
                        ...
                        <option value="<?php echo e($edit->categoria); ?>"><?php echo e($edit->categoria); ?></option>
                ...
                <div class="flex wrap justify-content-center w100">
                    ...
                    <div class="marTB10 fw25 txtCenter aux1">
                        ...
                        <input type="file" class="inputUploadImg " id="image" name="image" require value="<?php echo e($edit->image); ?>"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="<?php echo e(url('/miniatura/'.$edit->image)); ?>" />
                        </div>
                        <div class="imgProd ">
                            <div class="w100 flex" id="preview" value="<?php echo e($edit->image); ?>"></div>
                        </div>
                    ...
                    <div class="marTB10 fw25 txtCenter aux2" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg " id="image2" name="image2" value="<?php echo e($edit->image2); ?>"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="<?php echo e(url('/miniatura/'.$edit->image2)); ?>" />
                        </div>
                        <div class="imgProd">
                            <div class="w90" id="preview2" value="<?php echo e($edit->image2); ?>"></div>
                        </div>
                    </div>
                    <!--imagen3-->
                    <div class="marTB10 fw25 txtCenter aux3" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg" id="image3" name="image3" value="<?php echo e($edit->image3); ?>"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="<?php echo e(url('/miniatura/'.$edit->image3)); ?>" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux4" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg " id="image4" name="image4" value="<?php echo e($edit->image4); ?>"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="<?php echo e(url('/miniatura/'.$edit->image4)); ?>" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux5" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg " id="image5" name="image5" value="<?php echo e($edit->image5); ?>"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="<?php echo e(url('/miniatura/'.$edit->image5)); ?>" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux6" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg" id="image6" name="image6" value="<?php echo e($edit->image6); ?>"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="<?php echo e(url('/miniatura/'.$edit->image6)); ?>" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux7" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg" id="image7" name="image7" value="<?php echo e($edit->image7); ?>"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="<?php echo e(url('/miniatura/'.$edit->image7)); ?>" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux8" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg" id="image8" name="image8" value="<?php echo e($edit->image8); ?>"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="<?php echo e(url('/miniatura/'.$edit->image8)); ?>" />
                        </div>
                        <div class="imgProd">
...
<?php endif; ?><?php /**PATH C:\Users\yyyyy\Desktop\CanacoOnline\resources\views/edit/producto.blade.php ENDPATH**/ ?>