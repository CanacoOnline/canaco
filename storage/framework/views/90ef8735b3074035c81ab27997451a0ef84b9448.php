...
<?php $component->withAttributes([]); ?>
    ...
    <div class="full">
        <main class="divCenterJA">
            <form action="<?php echo e(route('productUpdate',['producto_id'=>$edit->id])); ?>" method="post" enctype="multipart/form-data"
                class="panel borde boxShadow  mar20 pad20 rel" id="uploadForm">
                <?php echo csrf_field(); ?>

                <h1 class="txtB tam36 txtCenter pad20">Editar Servicio</h1>
                <!--Tipo-->
                ...
                <div class="flex wrap justify-content-center w100">
                    ...
                    <div class="marTB10 fw25 txtCenter aux1">
                        ...
                        <input type="file" class="inputUploadImg " id="image" name="image"
...
<?php endif; ?><?php /**PATH C:\Users\yyyyy\Desktop\CanacoOnline\resources\views/edit/servicio.blade.php ENDPATH**/ ?>