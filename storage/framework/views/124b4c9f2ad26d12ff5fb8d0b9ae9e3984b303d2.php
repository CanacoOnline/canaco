<?php $__env->startSection('title', 'Subir Promoción'); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <main class="divCenterJA full">
        ...
        <form action="<?php echo e(route('saveProducto')); ?>" method="post" enctype="multipart/form-data"
            ...
            <h2 class="txtB tam36 txtCenter pad20">Subir Promoción</h2>
            <!--Tipo-->
            <input type="text" id="tipo" name="tipo" value="Promocion" style="display:none" />
            <!--Titutlo-->
            <div class="marTB10">
            ...
            <div class="marTB10">
                ...
                <input type="date" class="frm100 typeLinea lineaO  marTB10" id="fechaini" name="fechaini" min="20-01-01"
                    require>
...
<?php endif; ?><?php /**PATH C:\Users\yyyyy\Desktop\CanacoOnline\resources\views/archivos/crearPromocion.blade.php ENDPATH**/ ?>