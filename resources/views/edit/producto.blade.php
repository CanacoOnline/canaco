            ...
            <form action="{{ route('productUpdate',['producto_id'=>$edit->id])}}" method="post"
                ...
                <div class="flex wrap justify-content-center marB20">
                    ...
                    <select id="categoria" name="categoria"
                        ...
                        <option value="{{$edit->categoria}}">{{$edit->categoria}}</option>
                ...
                <div class="flex wrap justify-content-center w100">
                    ...
                    <div class="marTB10 fw25 txtCenter aux1">
                        ...
                        <input type="file" class="inputUploadImg " id="image" name="image" require value="{{$edit->image}}"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="{{url('/miniatura/'.$edit->image)}}" />
                        </div>
                        <div class="imgProd ">
                            <div class="w100 flex" id="preview" value="{{$edit->image}}"></div>
                        </div>
                        @if ($errors->has('image'))
                        <span class="help-block">
                    ...
                    <div class="marTB10 fw25 txtCenter aux2" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg " id="image2" name="image2" value="{{$edit->image2}}"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="{{url('/miniatura/'.$edit->image2)}}" />
                        </div>
                        <div class="imgProd">
                            <div class="w90" id="preview2" value="{{$edit->image2}}"></div>
                        </div>
                    </div>
                    <!--imagen3-->
                    <div class="marTB10 fw25 txtCenter aux3" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg" id="image3" name="image3" value="{{$edit->image3}}"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="{{url('/miniatura/'.$edit->image3)}}" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux4" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg " id="image4" name="image4" value="{{$edit->image4}}"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="{{url('/miniatura/'.$edit->image4)}}" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux5" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg " id="image5" name="image5" value="{{$edit->image5}}"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="{{url('/miniatura/'.$edit->image5)}}" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux6" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg" id="image6" name="image6" value="{{$edit->image6}}"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="{{url('/miniatura/'.$edit->image6)}}" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux7" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg" id="image7" name="image7" value="{{$edit->image7}}"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="{{url('/miniatura/'.$edit->image7)}}" />
                        </div>
                        <div class="imgProd">
                    ...
                    <div class="marTB10 fw25 txtCenter aux8" style="display:none;">
                        ...
                        <input type="file" class="inputUploadImg" id="image8" name="image8" value="{{$edit->image8}}"/>
                        <div class="imgProd">
                            <img class="wFull maxH270" src="{{url('/miniatura/'.$edit->image8)}}" />
                        </div>
                        <div class="imgProd">
